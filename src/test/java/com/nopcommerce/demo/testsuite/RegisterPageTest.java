...
public class RegisterPageTest extends TestBase {
    ...
    public void verifyThatUserShouldCreateAccountSuccessfully() {
        ...
        registerPage.selectFirstName("Jason");
        registerPage.selectLastName("Shoy");
        registerPage.selectDateOfBirth("21");
        registerPage.selectMonthOfBirth("July");
        registerPage.selectYearOfBirth("2004");
        registerPage.sendEmailText("jshoy123@gmail.com");
        registerPage.sendPasswordText("123456we");
        registerPage.sendConfirmText("123456we");
        registerPage.clickOnRegisterButton();
